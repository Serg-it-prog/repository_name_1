...
def summa(message):
    ...
    if amount > 0:
        ...
        bot.send_message(message.chat.id, 'Число должно быть больше нуля. Впишите сумму еще раз.')
        bot.register_next_step_handler(message, summa)
...
def my_currency(message):
    try:
        ...
        bot.send_message(message.chat.id, f'Чтото не так. Впишите сумму еще раз.')
